...
class Incident(Base):
    ...
    # Root Cause Analysis generated by AI Agent / Triage Engine
    ...
    # One-to-Many Relationship: An Incident aggregates multiple deduplicated Alerts
...
# Database Indexing
# 1. HNSW Index for sub-millisecond vector similarity search
Index(
